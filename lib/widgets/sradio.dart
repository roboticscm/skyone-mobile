...
class SRadio<T> extends StatefulWidget {
  ...
  @override
  _SRadioState<T> createState() => _SRadioState<T>();
}

class _SRadioState<T> extends State<SRadio<T>> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.materialTapTargetSize ?? themeData.materialTapTargetSize) {
      case MaterialTapTargetSize.padded:
        size = const Size(1.5 * kRadialReactionRadius, 1.5 * kRadialReactionRadius);
        break;
